...
function Cart() {
    ...
    useEffect(() => {
        const addTotal = carts.reduce((accumulator, item) => {
                        ...
                        return <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                            <div className="flex w-2/5">
                                ...
                                <div className="flex flex-col justify-between ml-4 flex-grow">
                                    ...
                                    <a onClick={() => handleRemove(cart.id)} href="#" className="font-semibold hover:text-red-500 text-gray-500 text-xs">Remove</a>
                                </div>
                            </div>
                            <div className="flex justify-center w-1/5">
                                <svg onClick={() => handleDecrement(cart.id)} className="fill-current text-gray-600 w-3" viewBox="0 0 448 512"><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z" />
                                </svg>

                                <input className="mx-2 border text-center w-8" type="text" value={cart.quantity} />

                                <svg onClick={() => handleIncrement(cart.id)} className="fill-current text-gray-600 w-3" viewBox="0 0 448 512">
