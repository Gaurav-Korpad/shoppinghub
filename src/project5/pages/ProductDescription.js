...
function ProductDescription() {
    ...
    const handleCart = (product, check) => {
        ...
        const singleProduct = cart?.find((item) => item.id === product.id)
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className='flex gap-3'>
                                <button onClick={() => handleCart(product, true)} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Buy Now</button>
